...
python ./tools/qa_subgraph_sampling.py --dataset mquake --hops n --sampling-method random -r --seed 30 > /tmp/neighborhood_1.txt
python ./tools/qa_subgraph_sampling.py --dataset mquake --hops n --sampling-method random -r --seed 30 > /tmp/neighborhood_2.txt
...
#python ./tests/check_run_files.py
# clean up
